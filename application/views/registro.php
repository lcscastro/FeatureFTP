...
<div class="register-box">
  ...
  <div class="register-box-body">
    <p class="login-box-msg">Atualização de Registro</p>

    <form action="../../index.html" method="post">
        <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Codigo do Cliente"disabled>
      ...
      <div class="form-group has-feedback">
        <input type="email" class="form-control" placeholder="Digite seu cpf">
...
<!--      </div>-->
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-8" style="padding-left: 40%">
